...
python ./scripts/dinov2-to-ggml.py --model_name facebook/dinov2-small-imagenet1k-1-layer
python ./scripts/dinov2-to-ggml.py --model_name facebook/dinov2-with-registers-small-imagenet1k-1-layer
